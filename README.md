...
**Joff** here! I am a web developer from Manila 🇵🇭. For the past decade, I am mostly focusing on web development using JavaScript.

Most of my time is spent mastering front-end development using JavaScript and Vue.js.
...
### 📓 [lsnote](https://github.com/jofftiquez/lsnote)

A modern `ls` alternative with notes, git integration, tree view, and more
...
### Affiliations
- [MYCURE Inc.](https://mycure.md) - VP Of Engineering
